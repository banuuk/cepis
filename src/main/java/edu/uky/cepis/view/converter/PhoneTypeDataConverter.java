 ...
 * @author  keerthi
 */
public class PhoneTypeDataConverter implements Converter {
	 ...
	 * 
	 */
	private static Logger log = Logger.getLogger(PhoneTypeDataConverter.class);
	/**
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		if (log.isDebugEnabled()) {
			System.out.println(PhoneTypeDataConverter.class
		...
		if (log.isDebugEnabled()) {
			if (arg0.isValidationFailed()) {
				System.out
						.println(PhoneTypeDataConverter.class
								+ ": Validation Failed>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>.");
			}
		}

		phoneType = this.getCepisGlobalComponentConfigurator()
				.findPhoneTypeByCode(arg2);
		return phoneType;
	}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		PhoneType phoneType = (PhoneType) arg2;
