 ...
 * @author  keerthi
 */
public class UKStatusDataConverter  implements Converter {
	 ...
	 * 
	 */
	private static Logger log = Logger.getLogger(UKStatusDataConverter.class);
	/**
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		if (log.isDebugEnabled()) {
			System.out.println(UKStatusDataConverter.class
		...
		ukStatus = this.getCepisGlobalComponentConfigurator()
				.findUKStatusByCode(arg2);
		return ukStatus;
	}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		UKStatus ukStatus = (UKStatus) arg2;
		return ukStatus.getStatusCode();
