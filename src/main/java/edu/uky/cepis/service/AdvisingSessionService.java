 ...
 * 
 */
public interface AdvisingSessionService {
	...
	public abstract List<AdvisingSession> getIncorrectAdvisingSessionList(
			Date currentDate, String status);

	public abstract boolean updateAdvisingSessions(List<AdvisingSession> advisingSessions, String newStatus);
