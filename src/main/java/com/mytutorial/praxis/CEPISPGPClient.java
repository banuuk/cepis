...
public class CEPISPGPClient {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputStream pubKey = new FileInputStream("C:\\Workspace\\cepis\\src\\main\\java\\edu\\uky\\cepis\\util\\operations\\security\\etsukscorelink-public.asc");
		byte[] encrypted = encrypt(original, readPublicKey(pubKey), null, true,
				true);
		...
		byte[] decrypted = decrypt(encrypted, secKey,
