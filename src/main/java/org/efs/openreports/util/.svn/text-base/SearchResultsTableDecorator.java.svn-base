...
/**
 * The <tt>SearchResultsTableDecorator</tt> class is a DisplayTag <tt>TableDecorator</tt> used to populate the <tt>Action</tt> and <tt>Tags</tt> columns of a DisplayTag table. These columns are generated based on the class of the current row object. Currently only <tt>Report</tt>, <tt>ReportGroup</tt>, and <tt>ReportUser</tt> classes are supported.
 */
