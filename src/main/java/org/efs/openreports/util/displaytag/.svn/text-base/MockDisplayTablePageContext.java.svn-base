...
/**
 * Mock PageContext that implements the methods and sets the attributes required
 * to use the DisplayTag exporting code outside of an actual servlet context.
 * 
...
public class MockDisplayTablePageContext extends PageContext {
	...
	public MockDisplayTablePageContext(String exportType,
			ApplicationContext applicationContext) {
		request.setupAddParameter(new ParamEncoder(null)
