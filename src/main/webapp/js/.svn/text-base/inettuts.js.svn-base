...
var iNettuts = {
    ...
    settings : {
        ...
        saveToCookie: 'cepis-widget-preferences',
        ...
        widgetDefault : {
            ...
            collapsible: true,
            editable: true,
            colorClasses : ['color-yellow', 'color-red', 'color-blue', 'color-white', 'color-orange', 'color-green','color-pink','color-black','color-navyblue','color-purple','color-chocalate','color-fb']
        },
        widgetIndividual : {}
    },
        ...
        $(settings.widgetSelector, $(settings.columns)).each(function () {
            ...
            if (thisWidgetSettings.removable) {
                $('<a href="#" class="remove">CLOSE</a>').mousedown(function (e) {
                    ...
                    if(confirm('CEPIS Warning: This portlet will be removed, ok?')) {
