	...
	<h:form id="register">
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Conference Registration" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		...
		<h:panelGroup layout="block" style="text-align:center;align:center;">
			<h:commandButton value="     Register    "
				action="#{conferenceManagementController.registerScannedUser}"></h:commandButton>
		</h:panelGroup>
		<script>
  document.getElementById('add:attendee:register:userid').focus();
</script>
	</h:form>
</f:subview>
