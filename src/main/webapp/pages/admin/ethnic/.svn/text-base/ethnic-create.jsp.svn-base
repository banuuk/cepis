...
<f:view afterPhase="#{appComponentController.initApplicationComponent}">
	<h:message for="create_ethnic_manager">
	</h:message>
	<h:form id="create_ethnic_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Create new ethnic"></h:outputText> </font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<h:panelGrid columns="2"
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Ethnic Code:"></h:outputText></font>
				<br />
			...
			<h:inputText value="#{appComponentController.kyEthnicCode}"
				style='width:200px'></h:inputText>
			<h:message for="create_ethnic_button"></h:message>
			<h:commandButton id="create_ethnic_button" value="Create"
				action="#{appComponentController.createEthnic}"></h:commandButton>
		</h:panelGrid>
	</h:form>
</f:view>
