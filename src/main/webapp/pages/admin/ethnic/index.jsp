...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "ethnic.cps");
	tabbar.setContentHref("a1", "ethnic-create.cps");
	tabbar.setContentHref("a2", "ethnic-edit.cps");
	tabbar.setContentHref("a3", "ethnic-delete.cps");
