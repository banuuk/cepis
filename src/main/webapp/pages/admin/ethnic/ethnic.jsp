...
<f:view>
	<br />
	<h:message for="ethnic_manager">
	</h:message>
	<h:form id="ethnic_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{ethnic.code}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program name" />
					</f:facet>
					<h:outputText value="#{ethnic.shortDesc}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program Description" />
					</f:facet>
					<h:outputText value="#{ethnic.kyEthnicCode}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} ethnic information available, displaying {1} ethnic information, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
