...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "program.cps");
	tabbar.setContentHref("a1", "program-create.cps");
	tabbar.setContentHref("a2", "program-edit.cps");
	tabbar.setContentHref("a3", "program-delete.cps");
