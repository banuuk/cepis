...
<f:view afterPhase="#{appComponentController.initApplicationComponent}">
	<h:message for="edit_program_manager">
	</h:message>
	<h:form id="edit_program_manager">
		<br />
		...
		<a4j:region selfRendered="true"
			ajaxListener="#{appComponentController.valueChangeEditProgram}"
			id="programlist_ajaxregion">
			...
			<h:panelGrid columns="2"
				...
				<h:inputText id="status" value="#{appComponentController.status}"
					style="width:200px"></h:inputText>
				<h:message for="edit_program_button"></h:message>
				<h:commandButton id="edit_program_button" value="Edit"
					action="#{appComponentController.editProgram}"></h:commandButton>
			</h:panelGrid>
		</a4j:region>
	</h:form>
</f:view>