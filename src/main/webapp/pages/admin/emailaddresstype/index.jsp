...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "emailaddresstype.cps");
		tabbar.setContentHref("a1", "emailaddresstype-create.cps");
		tabbar.setContentHref("a2", "emailaddresstype-edit.cps");
		tabbar.setContentHref("a3", "emailaddresstype-delete.cps");
