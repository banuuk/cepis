...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "ukterm.cps");
		tabbar.setContentHref("a1", "ukterm-create.cps");
		tabbar.setContentHref("a2", "ukterm-edit.cps");
		tabbar.setContentHref("a3", "ukterm-delete.cps");
