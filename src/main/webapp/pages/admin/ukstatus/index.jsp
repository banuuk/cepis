...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "ukstatus.cps");
		tabbar.setContentHref("a1", "ukstatus-create.cps");
		tabbar.setContentHref("a2", "ukstatus-edit.cps");
		tabbar.setContentHref("a3", "ukstatus-delete.cps");
