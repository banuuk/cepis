...
<f:view afterPhase="#{userDetailController.initApplicationComponent}">
	<h:message for="create_ukstatus_manager">
	</h:message>
	<h:form id="create_ukstatus_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Create new status for CEPIS System" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<h:panelGrid columns="2"
			...
			<h:message for="create_ukstatus_button"></h:message>
			<h:commandButton id="create_ukstatus_button" value="Create"
				action="#{userDetailController.createUKStatus}"></h:commandButton>
		</h:panelGrid>
	</h:form>
</f:view>