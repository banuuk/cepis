...
<link href="${facesContext.externalContext.requestContextPath}/css/template.css"
	media="screen" rel="stylesheet" type="text/css"/>
<f:view>
	<h:message for="ukstatus_manager">
	</h:message>
	<h:form id="ukstatus_manager">
		<br />
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{ukstatus.statusCode}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="UKStatus name" />
					</f:facet>
					<h:outputText value="#{ukstatus.shortDesc}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="UKStatus Description" />
					</f:facet>
					<h:outputText value="#{ukstatus.description}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Status" />
					</f:facet>
					<h:outputText value="#{ukstatus.status}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
