...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "cohorttype.cps");
	tabbar.setContentHref("a1", "cohorttype-create.cps");
	tabbar.setContentHref("a2", "cohorttype-edit.cps");
	tabbar.setContentHref("a3", "cohorttype-delete.cps");
