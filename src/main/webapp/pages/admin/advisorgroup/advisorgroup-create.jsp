...
<f:view afterPhase="#{appComponentController.initApplicationComponent}">
	<h:message for="create_advisorgroup_manager">
	</h:message>
	<h:form id="create_advisorgroup_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Create new Advisor Group"></h:outputText> </font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<h:panelGrid columns="2"
			...
			<h:panelGroup>
				...
				<br />
				<h:outputText value="Advisor Group Name, Max 50 chararcters." style="color:gray"></h:outputText>
			</h:panelGroup>
			<h:inputText value="#{appComponentController.name}"
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<h:message for="create_advisorgroup_button"></h:message>
			<h:commandButton id="create_advisorgroup_button" value="Create"
				action="#{appComponentController.createAdvisorGroup}"></h:commandButton>
		</h:panelGrid>
	</h:form>
</f:view>
