...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "advisorgroup.cps");
	tabbar.setContentHref("a1", "advisorgroup-create.cps");
	tabbar.setContentHref("a2", "advisorgroup-edit.cps");
	tabbar.setContentHref("a3", "advisorgroup-delete.cps");
