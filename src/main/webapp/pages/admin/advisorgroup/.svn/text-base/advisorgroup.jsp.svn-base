...
<f:view>
	<br />
	<h:message for="advisorgroup_manager">
	</h:message>
	<h:form id="advisorgroup_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{advisorgroup.name}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Short Description" />
					</f:facet>
					<h:outputText value="#{advisorgroup.shortDesc}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Last Edit" />
					</f:facet>
					<h:outputText value="#{advisorgroup.lastEdit}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} advisorgroups available, displaying {1} advisorgroups, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
