...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "role.cps");
		tabbar.setContentHref("a1", "role-create.cps");
		tabbar.setContentHref("a2", "role-edit.cps");
		tabbar.setContentHref("a3", "role-delete.cps");
