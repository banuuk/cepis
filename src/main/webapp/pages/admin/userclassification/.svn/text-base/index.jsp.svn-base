...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "userclassification.cps");
	tabbar.setContentHref("a1", "userclassification-create.cps");
	tabbar.setContentHref("a2", "userclassification-edit.cps");
	tabbar.setContentHref("a3", "userclassification-delete.cps");
