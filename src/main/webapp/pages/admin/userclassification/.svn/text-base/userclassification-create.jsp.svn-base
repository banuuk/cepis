...
<f:view afterPhase="#{appComponentController.initApplicationComponent}">
	<h:message for="create_userclassification_manager">
	</h:message>
	<h:form id="create_userclassification_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Create new User Classification"></h:outputText> </font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<h:panelGrid columns="2"
			...
			<h:inputText value="#{appComponentController.status}"
				style='width:200px'></h:inputText>&nbsp;&nbsp;&nbsp;&nbsp;
			<h:message for="create_userclassification_button"></h:message>
			<h:commandButton id="create_userclassification_button" value="Create"
				action="#{appComponentController.createUserClassification}"></h:commandButton>
		</h:panelGrid>
	</h:form>
</f:view>
