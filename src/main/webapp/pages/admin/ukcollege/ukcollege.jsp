...
<f:view>
	<br />
	<h:message for="ukcollege_manager">
	</h:message>
	<h:form id="ukcollege_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{ukcollege.ukCollegeCode}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Name" />
					</f:facet>
					<h:outputText value="#{ukcollege.collegeName}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Address" />
					</f:facet>
					<h:outputText value="#{ukcollege.collegeAddress}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Phone" />
					</f:facet>
					<h:outputText value="#{ukcollege.collegePhone}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Dean Name" />
					</f:facet>
					<h:outputText value="#{ukcollege.collegeDeanName}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Sort Info" />
					</f:facet>
					<h:outputText value="#{ukcollege.collegeSpeedSort}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} colleges available, displaying {1} colleges, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
