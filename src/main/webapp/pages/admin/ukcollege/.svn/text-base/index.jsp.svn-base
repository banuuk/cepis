...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "ukcollege.cps");
	tabbar.setContentHref("a1", "ukcollege-create.cps");
	tabbar.setContentHref("a2", "ukcollege-edit.cps");
	tabbar.setContentHref("a3", "ukcollege-delete.cps");
