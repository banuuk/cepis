...
<f:view>
	<br />
	<h:message for="program_group_manager">
	</h:message>
	<h:form id="program_group_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{programGroup.programGroupCode}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program Group name" />
					</f:facet>
					<h:outputText value="#{programGroup.shortDesc}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program Group Description" />
					</f:facet>
					<h:outputText value="#{programGroup.description}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Status" />
					</f:facet>
					<h:outputText value="#{programGroup.status}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} program groups available, displaying {1} program groups, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
