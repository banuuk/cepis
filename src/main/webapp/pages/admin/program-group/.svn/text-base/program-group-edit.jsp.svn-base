...
<f:view afterPhase="#{appComponentController.initApplicationComponent}">
	<h:message for="edit_program_group_manager">
	</h:message>
	<h:form id="edit_program_group_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Edit existing program group" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<a4j:region selfRendered="true"
			ajaxListener="#{appComponentController.valueChangeEditProgramGroup}"
			id="programgrouplist_ajaxregion">
			...
			<h:panelGrid columns="2"
				...
				<h:panelGroup>
					<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
						value="Program Group Code:"></h:outputText></font>
					<br />
				...
				<h:panelGroup>
					<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
						value="Program Group short description:"></h:outputText></font>
					<br />
					<h:outputText
				...
				<h:panelGroup>
					<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
						value="Program Group description:"></h:outputText></font>
					<br />
					<h:outputText
						value="General description about the program group. Max 1000 characters"
						style="color:gray"></h:outputText>
				</h:panelGroup>
				...
				<h:panelGroup>
					<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
						value="Program Group status:"></h:outputText></font>
					<br />
					<h:outputText
						value="Status of the program group. possible values - current,old,unknown"
						style="color:gray"></h:outputText>
				</h:panelGroup>
				<h:inputText id="status" value="#{appComponentController.status}"
					style="width:200px"></h:inputText>
				<h:message for="edit_program_group_button"></h:message>
				<h:commandButton id="edit_program_group_button" value="Edit"
					action="#{appComponentController.editProgramGroup}"></h:commandButton>
			</h:panelGrid>
		</a4j:region>
	</h:form>
</f:view>