...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "program-group.cps");
	tabbar.setContentHref("a1", "program-group-create.cps");
	tabbar.setContentHref("a2", "program-group-edit.cps");
	tabbar.setContentHref("a3", "program-group-delete.cps");
