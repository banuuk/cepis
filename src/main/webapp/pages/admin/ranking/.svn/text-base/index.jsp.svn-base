...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "ranking.cps");
		tabbar.setContentHref("a1", "ranking-create.cps");
		tabbar.setContentHref("a2", "ranking-edit.cps");
		tabbar.setContentHref("a3", "ranking-delete.cps");
