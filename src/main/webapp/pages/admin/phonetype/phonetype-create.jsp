...
<f:view afterPhase="#{userDetailController.initApplicationComponent}">
	<h:message for="create_phonetype_manager">
	</h:message>
	<h:form id="create_phonetype_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Create new phonetype for CEPIS System" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<h:panelGrid columns="2"
			...
			<h:commandButton id="create_addresstype_button" value="Create"
				action="#{userDetailController.createPhoneType}"></h:commandButton>
		</h:panelGrid>
	</h:form>
</f:view>