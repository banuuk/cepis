...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "phonetype.cps");
		tabbar.setContentHref("a1", "phonetype-create.cps");
		tabbar.setContentHref("a2", "phonetype-edit.cps");
		tabbar.setContentHref("a3", "phonetype-delete.cps");
