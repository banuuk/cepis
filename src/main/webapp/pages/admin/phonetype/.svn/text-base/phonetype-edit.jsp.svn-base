...
<f:view afterPhase="#{userDetailController.initApplicationComponent}">
	<h:message for="edit_phonetype_manager">
	</h:message>
	<h:form id="edit_phonetype_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Edit existing phone type" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<a4j:region selfRendered="true"
			ajaxListener="#{userDetailController.valueChangeEditPhoneType}"
			id="phonetypelist_ajaxregion">
			...
			<h:panelGrid columns="2"
				...
				<h:selectOneListbox id="phonetype_list_id"
					...
					style="width:200px" converter="#{PhoneTypeDataConverter}">
				...
				<h:message for="edit_phonetype_button"></h:message>
				<h:commandButton id="edit_phonetype_button" value="Edit"
					action="#{userDetailController.editPhoneType}"></h:commandButton>
			</h:panelGrid>
		</a4j:region>
	</h:form>
</f:view>