...
<f:view>
	<br />
	<h:message for="program_domain_manager">
	</h:message>
	<h:form id="program_domain_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{programDomain.programDomainCode}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program Domain name" />
					</f:facet>
					<h:outputText value="#{programDomain.shortDesc}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program Domain Description" />
					</f:facet>
					<h:outputText value="#{programDomain.description}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Status" />
					</f:facet>
					<h:outputText value="#{programDomain.status}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Program List" />
					</f:facet>
					<h:commandLink action="admin_program_domain_view_program">
		...
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} program domains available, displaying {1} program domains, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
