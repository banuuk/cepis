...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.addTab("a0", "List", "100px");
	tabbar.addTab("a1", "Create", "100px");
	tabbar.addTab("a2", "Edit", "100px");
	tabbar.addTab("a3", "Delete", "100px");
	tabbar.addTab("a4", "Add Program", "100px");
	tabbar.addTab("a5", "Remove Program", "100px");
	tabbar.setHrefMode("iframes-on-demand");
	tabbar.setContentHref("a0", "program-domain.cps");
	tabbar.setContentHref("a1", "program-domain-create.cps");
	tabbar.setContentHref("a2", "program-domain-edit.cps");
	tabbar.setContentHref("a3", "program-domain-delete.cps");
	tabbar.setContentHref("a4", "program-domain-add-program.cps");
	tabbar.setContentHref("a5", "program-domain-remove-program.cps");
