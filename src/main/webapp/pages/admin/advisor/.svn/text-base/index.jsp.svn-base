...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.addTab("a1", "Add", "100px");
		tabbar.addTab("a2", "Update", "100px");

		tabbar.setHrefMode("iframes-on-demand");
		tabbar.setContentHref("a0", "advisor.cps");
		tabbar.setContentHref("a1", "advisor-add.cps");
		tabbar.setContentHref("a2", "advisor-update.cps");
