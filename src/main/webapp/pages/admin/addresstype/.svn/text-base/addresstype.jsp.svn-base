...
<f:view>
	<br />
	<h:message for="addresstype_manager">
	</h:message>
	<h:form id="addresstype_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{addresstype.code}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Name" />
					</f:facet>
					<h:outputText value="#{addresstype.desc}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
