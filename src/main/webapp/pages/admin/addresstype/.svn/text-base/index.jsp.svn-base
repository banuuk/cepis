...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "addresstype.cps");
		tabbar.setContentHref("a1", "addresstype-create.cps");
		tabbar.setContentHref("a2", "addresstype-edit.cps");
		tabbar.setContentHref("a3", "addresstype-delete.cps");
