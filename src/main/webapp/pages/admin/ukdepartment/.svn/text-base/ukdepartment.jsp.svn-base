...
<f:view>
	<br />
	<h:message for="ukdepartment_manager">
	</h:message>
	<h:form id="ukdepartment_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{ukdepartment.departmentCode}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Name" />
					</f:facet>
					<h:outputText value="#{ukdepartment.departmentName}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Address" />
					</f:facet>
					<h:outputText value="#{ukdepartment.departmentAddress}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Contact" />
					</f:facet>
					<h:outputText value="#{ukdepartment.departmentContact}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Dept. Chair Name" />
					</f:facet>
					<h:outputText value="#{ukdepartment.departmentChairName}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Short Desc" />
					</f:facet>
					<h:outputText value="#{ukdepartment.shortDescription}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Status" />
					</f:facet>
					<h:outputText value="#{ukdepartment.status}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Sort Info" />
					</f:facet>
					<h:outputText value="#{ukdepartment.speedSort}"></h:outputText>
				</h:column>
			</t:dataTable>
		</h:panelGroup>
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} departments available, displaying {1} departments, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
