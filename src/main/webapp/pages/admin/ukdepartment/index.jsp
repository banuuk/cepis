...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "ukdepartment.cps");
	tabbar.setContentHref("a1", "ukdepartment-create.cps");
	tabbar.setContentHref("a2", "ukdepartment-edit.cps");
	tabbar.setContentHref("a3", "ukdepartment-delete.cps");
