...
<f:view>
	<br />
	<h:message for="cohortterm_manager">
	</h:message>
	<h:form id="cohortterm_manager">
		...
		<h:panelGroup id="body">
			<t:dataTable id="scrollList" styleClass="scrollTable"
				...
				<h:column>
					...
					<h:outputText value="#{cohortterm.termCode}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Name" />
					</f:facet>
					<h:outputText value="#{cohortterm.shortDesc}"></h:outputText>
				</h:column>
				<h:column>
					<f:facet name="header">
						<h:outputText value="Description" />
					</f:facet>
					<h:outputText value="#{cohortterm.description}"></h:outputText>
				</h:column>
		...
		<h:panelGrid id="scrollers" columns="1" styleClass="scrollerTable2"
			...
			<t:dataScroller id="scroll_0" for="scrollList"
				...
				<h:outputFormat
					value="{0} cohortterms available, displaying {1} cohortterms, from {2} to {3}. Page {4} / {5}"
					styleClass="standard">
