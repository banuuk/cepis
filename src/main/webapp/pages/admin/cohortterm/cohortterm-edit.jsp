...
<f:view afterPhase="#{appComponentController.initApplicationComponent}">
	<h:message for="edit_cohortterm_manager">
	</h:message>
	<h:form id="edit_cohortterm_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Edit existing cohortterm" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<a4j:region selfRendered="true"
			ajaxListener="#{appComponentController.valueChangeEditCohortTerm}"
			id="cohorttermlist_ajaxregion">
			...
			<h:panelGrid columns="2"
				...
				<h:message for="edit_cohortterm_button"></h:message>
				<h:commandButton id="edit_cohortterm_button" value="Edit"
					action="#{appComponentController.editCohortTerm}"></h:commandButton>
			</h:panelGrid>
		</a4j:region>
	</h:form>
</f:view>