...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	<TR valign=top>
		...
		tabbar.setContentHref("a0", "ukmajor.cps");
		tabbar.setContentHref("a1", "ukmajor-create.cps");
		tabbar.setContentHref("a2", "ukmajor-edit.cps");
		tabbar.setContentHref("a3", "ukmajor-delete.cps");
