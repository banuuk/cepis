...
<f:view afterPhase="#{userDetailController.initApplicationComponent}">
	<h:message for="edit_ukmajor_manager">
	</h:message>
	<h:form id="edit_ukmajor_manager">
		<br />
		...
		<h:panelGrid columns="2">
			...
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
					value="Edit existing major" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<a4j:region selfRendered="true"
			ajaxListener="#{userDetailController.valueChangeEditUKMajor}"
			id="ukmajorlist_ajaxregion">
			...
			<h:panelGrid columns="2"
				...
				<h:selectOneListbox id="ukmajor_list_id"
					value="#{userDetailController.selectedUKMajor}" size="1"
					style="width:200px" converter="#{UKMajorDataConverter}">
					<f:selectItem itemLabel="Select One" itemValue="NA" />
					<f:selectItems
						value="#{cepisGlobalComponentConfigurator.ukMajorList}"
						var="ukMajor" itemLabel="#{ukMajor.shortDesc}" />
				...
				<h:inputText id="degreeLevel"
					value="#{userDetailController.degreeLevel}" style="width:200px"></h:inputText>
				<h:panelGroup>
					<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
				...
				<h:inputText id="status" value="#{userDetailController.status}"
					style="width:200px"></h:inputText>
				<h:message for="edit_ukmajor_button"></h:message>
				<h:commandButton id="edit_ukmajor_button" value="Edit"
					action="#{userDetailController.editUKMajor}"></h:commandButton>
			</h:panelGrid>
		</a4j:region>
	</h:form>
</f:view>