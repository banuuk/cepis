...
<TABLE bgcolor="#FFFFFF" border=0 cellpadding=0 cellspacing=0>
	...
	tabbar.setContentHref("a0", "program-track.cps");
	tabbar.setContentHref("a1", "program-track-create.cps");
	tabbar.setContentHref("a2", "program-track-edit.cps");
	tabbar.setContentHref("a3", "program-track-delete.cps");
