		...
		<h:panelGroup id="praxisII_list">			
			<rich:extendedDataTable id="praxisII_Table" styleClass="basicTable"
				...
				<rich:column id="candidateId_Col" width="8%">
					...
					<h:panelGroup>
						<h:outputText value="#{praxisIITestScore.candidateId}"/>
					</h:panelGroup>
				</rich:column>
				<rich:column id="praxisIITestTitle_Col" width="25%"
				...
				<rich:column id="praxisIITestDate_Col" width="8%"
				...
				<rich:column id="praxisIIScore_Col" width="8%"
				...
				<rich:column id="praxisIICutoff_Col" width="8%"
				...
				<rich:column id="praxisIIMadeCutoff_Col" width="8%"
				...
				<rich:column id="praxisIIPrimary_Col" width="8%"
		...
		<h:form id="praxisII_entry_form" styleClass="styleish">
			<h:panelGroup id="praxisII_entry">		
				<h:panelGrid columns="2" cellpadding="5"  styleClass="highlightClass" width="100%">				
						...
						<h:inputText id="candidateId" value="#{testScoreController.praxisIICandidateId}" 
		...
		<rich:modalPanel id="selectedPraxisIIScoreEditPanel" height="450" width="550" autosized="true" domElementAttachment="parent">
			...
			<h:form styleClass="styleish">
				...
				<h:panelGrid columns="2" cellpadding="5"  styleClass="highlightClass" width="100%">	
					...
					<h:inputText id="editCandidateId" value="#{testScoreController.selectedPraxisIITestScore.candidateId}" 
					required="true" requiredMessage="Candidate Id: Value is required.">
					</h:inputText>
					...
					<h:outputLabel for="editRecievedDate" value="Recieved Date: " styleClass="small"/>
					<rich:calendar id="editRecievedDate" value="#{testScoreController.selectedPraxisIITestScore.receivedDate}"
						cellWidth="24px" datePattern="MM/dd/yyyy" enableManualInput="true"
						cellHeight="22px" style="width:200px" required="true" requiredMessage="Recieved Date: Value is Required">
					</rich:calendar>	
