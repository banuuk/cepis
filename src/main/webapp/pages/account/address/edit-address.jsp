	...
	<h:form>
		...
		<h:panelGrid columns="2"
			...
			<h:panelGroup>
				...
				<h:selectOneListbox
					...
					<a4j:support event="onchange" ajaxSingle="true"
						actionListener="#{accountManagementController.valueChangeEditAddress}"
			...
			<h:inputText id="edit_address_street1"
				value="#{accountManagementController.street1}" style="width:200px"
			...
			<h:inputText id="edit_address_street2"
				value="#{accountManagementController.street2}" style="width:200px">
			...
			<h:inputText id="edit_address_city"
				value="#{accountManagementController.city}" style="width:200px"
			...
			<rich:comboBox id="edit_address_state" value="#{accountManagementController.state}"
			...
			<h:inputText id="edit_address_zip"
				value="#{accountManagementController.zip}" style="width:200px"
			...
			<h:selectOneListbox id="edit_address_country"
				value="#{accountManagementController.country}" size="1" style="width:200px"
			...
			<h:message for="edit_address_button"></h:message>
			<h:commandButton id="edit_address_button" value="Save"
				action="#{accountManagementController.editAddressDetail}">
			</h:commandButton>
		</h:panelGrid>
	</h:form>
</f:subview>