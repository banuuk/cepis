		...
		<h:panelGrid columns="2"
			...
			<h:selectOneMenu id="emailAddressListid"
				...
				<a4j:support event="onchange" ajaxSingle="true"
					actionListener="#{accountManagementController.valueChangeEditEmailAddress}"
			...
			<h:panelGroup>
				...
				<h:inputText id="address"
					value="#{accountManagementController.address}" style="width:200px"
			...
			<h:message for="edit_email_address_button"></h:message>
			<h:commandButton id="edit_email_address_button" value="Save"
				action="#{accountManagementController.editEmailAddressDetail}">
			</h:commandButton>
		</h:panelGrid>
	</h:form>
</f:subview>