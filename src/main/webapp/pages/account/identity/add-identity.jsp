...
<link
	...
	media="screen" rel="stylesheet" type="text/css" />
<f:subview id="add-user">
	<h:form id="add_user_manager">
		<br />
		<h:panelGrid columns="2">
			<h:graphicImage url="/images/info.png" alt="i" title="Info" />
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"> <h:outputText
						value="Create new CEPIS user account without User Program and College Profiles (Administrator Only)" /></font>
			</h:panelGroup>
		</h:panelGrid>
		<br />
		<br />
		<h:panelGrid columns="2"
			...
			<h:inputText value="#{accountManagementController.username}"
				...
				<a4j:support event="onblur" ajaxSingle="true"
					...
					reRender="ukid,lname,fname,mname,preferredName,usertype_list_id,pp,emailaddress,phoneno" />
			...
			<h:inputText id="lname" value="#{accountManagementController.lName}"
				style="width:200px" required="true"
			...
			<h:inputText id="fname" value="#{accountManagementController.fName}"
				style="width:200px" required="true"
				requiredMessage="First name: Value is required.">
				<f:validateLength maximum="50" />
				<a4j:support event="onblur" ajaxSingle="true" limitToList="true"
					reRender="preferredName"
					actionListener="#{accountManagementController.valueChangefName}"></a4j:support>
			</h:inputText>
			<h:panelGroup>
				<font class="ws10" color="#062E8A" face="Tahoma"><h:outputText
			...
			<h:inputText id="mname" value="#{accountManagementController.mName}"
				style="width:200px"
			...
			<h:inputText id="title" value="#{accountManagementController.title}"
			...
			<h:message for="add_user_button"></h:message>
			<h:commandButton id="add_user_button" value="Add User"
				action="#{accountManagementController.addRogueUser}"></h:commandButton>
		</h:panelGrid>
	</h:form>
</f:subview>
