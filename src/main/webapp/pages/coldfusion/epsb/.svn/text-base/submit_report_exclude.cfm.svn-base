<cf_page title="EPSB Admissions & Exit Reports">
	...
	<cfelse>
		...
		<cfif FileExists("xml/Adm.xml")>
			<cffile action="delete" file="xml/Adm.xml">
		</cfif>
		<cfif FileExists("xml/Re-Adm.xml")>	
			<cffile action="delete" file="xml/Re-Adm.xml">
		</cfif>		
		<cfif FileExists("xml/Exit.xml")>
			<cffile action="delete" file="xml/Exit.xml">
		</cfif>
		<cfif FileExists("xml/Re-Exit.xml")>
			<cffile action="delete" file="xml/Re-Exit.xml">
		</cfif>
...
<cfloop from="1" to="2" index="mainLoop">
	<cfxml variable="StudentRecord" caseSensitive="yes">
	 ...
	 <cfelseif mainLoop EQ 1>
		<cfquery name="stuiden" datasource="DataReview">	
			SELECT tblIdentity.SID, tblIdentity.UID, tblIdentity.LName, tblIdentity.FName, tblIdentity.MName, tblIdentity.Title, 
				   tblIdentity.Suffix,tblIdentity.Dob, tblTepadmission.Termcode, tblTepadmission.Tepadmissioncode, tblIdentity.Gender, lstEthnic.KYethniccode, tblTepadmission.Writtencommunication, 
	...
	<cfloop from="1" to="#stuiden.RecordCount#" index="ctr">
		...
		<cfoutput>
			...
			<Student_Record>
				...
				<cfoutput>
					...
					<cfquery name="sturem" datasource="DataReview">
						select  ethniccode, Computeraddress
					...
					<cfloop from="1" to="#sturem.RecordCount#" index="ctr4">
						<cfscript>
							DOB = DateFormat(stuiden.Dob[ctr], "yyyy-mm-dd"); 
					...
					<cfquery name="stuprog" datasource="DataReview">
						select lp.EPSBProgramcode1, lp.EPSBProgramcode2, lp.Certificate1, lp.Certificate2, tp.StatusChangeTerm, ta.Tepadmissiondate, 
					...
					<cfloop from="1" to="#stuprog.RecordCount#" index="ctr6">
						<cfscript>
							...
							AnticptdCompTerm = stuprog.StatusChangeTerm[ctr6];
							Completedate = "";
			...
			<Date_of_Program_Completion>#Completedate#</Date_of_Program_Completion>
				...
				<cfset myvar=toString(StudentRecord)>
				 <cfinvoke webservice="https://wd.kyepsb.net/EPSB.WebApps/AdmissionsExit/TepXmlWebService/TEPXmlSubmission.asmx?wsdl" method = "SubmitXml" returnvariable="returndXML">
				   <cfinvokeargument name="theXML" value = "#myvar#">
				...
				<cfif mainLoop EQ 1 and admflag EQ 1 >
					<cffile action="write" file="xml/Re-Adm.xml" output="#returndXML#" mode="777"> 
					<cffile action="write" file="xml/Adm.xml" output="#myvar#" mode="777">
					
				<cfelseif mainLoop EQ 2 and exitflag EQ 1>
					<cffile action="write" file="xml/Re-Exit.xml" output="#returndXML#" mode="777"> 
					<cffile action="write" file="xml/Exit.xml" output="#myvar#" mode="777">	 
				</cfif>
			</cfloop>
			...
			<!---<cffile action="read" file="xml/Adm.xml" variable="XMLFileText">
			<cfset myXMLDocument=XmlParse(XMLFileText)>
			<cfdump var="myXMLDocument">
			 
			<cfif FileExists("xml/Re-Adm.xml") AND FileExists("xml/Re-Exit.xml")>
