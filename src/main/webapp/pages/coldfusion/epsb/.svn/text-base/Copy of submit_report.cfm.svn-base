<cf_page title="EPSB Admissions & Exit Reports">
	...
	<cfelse>
		...
		<cfif FileExists("/usr/local/apache/htdocs/coesis/webservice/xml/Adm.xml")>
			<cffile action="delete" file="/usr/local/apache/htdocs/coesis/webservice/xml/Adm.xml">
		</cfif>
		<cfif FileExists("/usr/local/apache/htdocs/coesis/webservice/xml/Re-Adm.xml")>	
			<cffile action="delete" file="/usr/local/apache/htdocs/coesis/webservice/xml/Re-Adm.xml">
		</cfif>		
		<cfif FileExists("/usr/local/apache/htdocs/coesis/webservice/xml/Exit.xml")>
			<cffile action="delete" file="/usr/local/apache/htdocs/coesis/webservice/xml/Exit.xml">
		</cfif>
		<cfif FileExists("/usr/local/apache/htdocs/coesis/webservice/xml/Re-Exit.xml")>
			<cffile action="delete" file="/usr/local/apache/htdocs/coesis/webservice/xml/Re-Exit.xml">
		</cfif>
			...
			select ti.UID, ti.SID, FName, MName, LName, Suffix, Title, Gender, ta.ProgUID 
			    ...
			    where tp.UID = ti.UID 
					and ta.ProgUID = tp.ProgUID 				   
				 	...
				 	and tp.Anticipatedcompletionterm ="#reportTerm#"
		...
		<cfoutput>
			...
			<Student_Record>
				...
				<cfoutput>
					...
					<cfif Compare(Gender, "female") EQ 0>
						<cfset Gender = Replace(Gender, "female", "Female")>
					<cfelseif Compare(Gender, "male") EQ 0>
			...
			<Date_of_Program_Completion>#Completedate#</Date_of_Program_Completion>
				...
				<cfif (mainLoop EQ 1 and admflag EQ 1) or (mainLoop EQ 2 and exitflag EQ 1) >
				 ...
				 <cfinvoke webservice="https://wd.kyepsb.net/EPSB.WebApps/AdmissionsExit/TepXmlWebService/TEPXmlSubmission.asmx?wsdl" method = "SubmitXml" returnvariable="returndXML">
				   ...
				   <cfinvokeargument name="password" value = "K72XPDB5">
				</cfinvoke>  
				</cfif>
				...
				<cfif mainLoop EQ 1 and admflag EQ 1 >
					<cffile action="write" file="/usr/local/apache/htdocs/coesis/webservice/xml/Re-Adm.xml" output="#returndXML#" mode="777"> 
					<cffile action="write" file="/usr/local/apache/htdocs/coesis/webservice/xml/Adm.xml" output="#StudentRecord#" mode="777">
					
				<cfelseif mainLoop EQ 2 and exitflag EQ 1>
					<cffile action="write" file="/usr/local/apache/htdocs/coesis/webservice/xml/Re-Exit.xml" output="#returndXML#" mode="777"> 
					<cffile action="write" file="/usr/local/apache/htdocs/coesis/webservice/xml/Exit.xml" output="#StudentRecord#" mode="777">	 
				</cfif>
			</cfloop>
			...
			<td class="label">To view the XML files in a new browser, <br/> Click on the below hyperlinks : </td><br/>
				<cfif admflag EQ 1>
				<td width="400"> <a href="http://dametest.coe.uky.edu/coesis/webservice/xml/Adm.xml" target="_blank">View Submitted Admission Report</a></td><br/>
				<td width="400"><a href="http://dametest.coe.uky.edu/coesis/webservice/xml/Re-Adm.xml" target="_blank">View Reply_For_Admission Report</a></td><br/><br/><br/>
				</cfif>
				<cfif exitflag EQ 1>
				<td width="400"><a href="http://dametest.coe.uky.edu/coesis/webservice/xml/Exit.xml" target="_blank">View Submitted Exit Report</a></td><br/>
				<td width="400"><a href="http://dametest.coe.uky.edu/coesis/webservice/xml/Re-Exit.xml" target="_blank">View Reply_For_Exit Report</a></td><br/><br/><br/><br/>
				</cfif>
			...
			<!---<cffile action="read" file="/usr/local/apache/htdocs/coesis/webservice/xml/Adm.xml" variable="XMLFileText">
			<cfset myXMLDocument=XmlParse(XMLFileText)>
			<cfdump var="myXMLDocument">
			 
			<cfif FileExists("/usr/local/apache/htdocs/coesis/webservice/xml/Re-Adm.xml") AND FileExists("/usr/local/apache/htdocs/coesis/webservice/xml/Re-Exit.xml")>
